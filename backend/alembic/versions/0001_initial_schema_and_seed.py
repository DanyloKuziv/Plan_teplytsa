...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("heating_type", postgresql.ENUM("gas", "wood", "electric", "heat_pump", name="heatingtype", create_type=False), nullable=False),
        sa.Column("heating_power_kw", sa.Float, nullable=False),
        sa.Column("fuel_cost_per_unit", sa.Float, nullable=False),
        sa.Column("insulation_type", postgresql.ENUM("none", "basic", "good", name="insulationtype", create_type=False), nullable=False),
        sa.Column("created_at", sa.DateTime, nullable=False, server_default=sa.func.now()),
    )
    ...
    op.create_table(
        ...
        sa.Column("phase", postgresql.ENUM("seedling", "growth", "flowering", "ripening", name="growthphase", create_type=False), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("growth_phase", postgresql.ENUM("seedling", "growth", "flowering", "ripening", name="growthphase", create_type=False), nullable=False),
    )
